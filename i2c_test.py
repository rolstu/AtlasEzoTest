...
def get_devices():
    ...
    if not device_list:
        print(">> No valid devices found. Please check your connections.")
                ...
                while True:
                    ...
                    for dev in device_list:
                        try:
                            ...
                            print(f"Error writing to device at address {dev.address}: {e}")
                            break  # Break out of the loop to handle the error
